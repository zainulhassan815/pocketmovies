...
fun Modifier.materialPlaceholder(
    ...
    placeholder(
        ...
        highlight = PlaceholderHighlight.shimmer(
            highlightColor = MaterialTheme.colorScheme.surfaceColorAtElevation(5.dp),
        ),
        shape = shape
    )
}
...
fun Modifier.placeholder(
    ...
    val transition = updateTransition(transitionState, "placeholder_cross_fade")
